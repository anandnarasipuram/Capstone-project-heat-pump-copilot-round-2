...
7. **Performance/evaluation approach** — offline unit tests (16 tests, [../mvp/mvp_documentation.md](../mvp/mvp_documentation.md)), live per-interaction LangSmith tracing in the MVP (grown from the Round 1 trace sample/experiment — [../langsmith/monitoring_notes.md](../langsmith/monitoring_notes.md)), dashboard operational metrics
